...
def main():
    ...
    args.names = pathlib.Path('data/sod/processed/test-names.txt')
    args.names1 = pathlib.Path("data/sod-bar/processed/test-names.txt")
    args.names2 = pathlib.Path("data/sod-track/processed/test-names.txt")
