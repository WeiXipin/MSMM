...
def main():
    ...
    args.train_names = pathlib.Path('data/sod/processed/train-names.txt')
    args.train_names1 = pathlib.Path("data/sod-bar/processed/train-names.txt")
    args.train_names2 = pathlib.Path("data/sod-track/processed/train-names.txt")
    
    args.valid_names = pathlib.Path(
            f"data/sod/processed/valid-names.txt"
    )
    args.valid_names1 = pathlib.Path(
            f"data/sod-bar/processed/valid-names.txt"
    )
    args.valid_names2 = pathlib.Path(
            f"data/sod-track/processed/valid-names.txt"
    )
    args.in_dir = pathlib.Path(f"data/sod/processed/notes/")
    args.in_dir1 = pathlib.Path(f"data/sod-bar/processed/notes/")
    args.in_dir2 = pathlib.Path(f"data/sod-track/processed/notes/")
    
    args.out_dir = pathlib.Path(f"exp/sod-bar")
