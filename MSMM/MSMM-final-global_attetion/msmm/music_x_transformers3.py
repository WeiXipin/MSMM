...
class M3(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.emb_dropout3 = nn.Dropout(emb_dropout)
    ...
    def forward(
        ...
        **kwargs,
        ...
        x = self.emb_dropout3(x)

        x = self.project_emb3(x)
...
class MusicAutoregressiveWrapper3(nn.Module):
...
class MusicXTransformer3(nn.Module):
    def __init__(self, *, dim, encoding, **kwargs):
        ...
        self.decoder = MusicTransformerWrapper3(
            encoding=encoding,
            attn_layers=Decoder(dim=dim, **kwargs),
            **transformer_kwargs,
        )
        self.decoder = MusicAutoregressiveWrapper3(
